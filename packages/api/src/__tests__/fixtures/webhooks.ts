import type { RegistrationPayload, AttendancePayload, OrderPayload, PaymentPayload } from '@ecomspace/shared';

// Tuesday 2026-03-10 at 18:30 MSK (15:30 UTC)
export const registrationPayload: RegistrationPayload = {
  ...
  phone: '+79001234567',
  name: 'Тест Тестов',
  webinar_date: '2026-03-10T20:00:00+03:00', // вебинар 10 марта
  funnel: 'main',
  utm_source: 'yandex',
  utm_medium: 'cpc',
...
// Registration for Thursday webinar
export const registrationThursdayPayload: RegistrationPayload = {
  gc_deal_id: 'reg-deal-thu-001',
  gc_user_id: 'user-002',
  email: 'thu-user@mail.ru',
  webinar_date: '2026-03-12T20:00:00+03:00', // вебинар 12 марта (четверг)
  funnel: 'vip',
  registered_at: '2026-03-11T15:00:00+03:00',
};
...
export const attendanceOldPayload: AttendancePayload = {
  ...
  attended_at: '2026-03-03T20:05:00+03:00', // a week before
};
